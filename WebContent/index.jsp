...
<html>
	...
	<body>
		...
		<form  id="login" action="loginServlet" method="post" class="form-horizontal">	
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-3">
					<input type="submit" value="登录" class="btn-info form-control"/>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-md-8 col-md-offset-7">
					<span><a href="<%=request.getContextPath() %>/register.jsp">注册</a>|<a href="#">忘记密码?</a></span>
				</div>
			</div>
		</form>
       ...
       -->
		...
		<script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery_MD5.js"></script>
